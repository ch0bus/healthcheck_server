...
См. [realtime_monitoring_cheatsheet.md](realtime_monitoring_cheatsheet.md), **htop**: [htop_cheatsheet.md](htop_cheatsheet.md), **память/load/OOM**: [memory_and_load_cheatsheet.md](memory_and_load_cheatsheet.md).
